...
class SaleOrderLine(models.Model):
    ...
    def _onchange_size(self):
        self.size_front = self.sizes.size_front
        self.size_width = self.sizes.size_width
        self.size_front_length = self.sizes.size_front_length
    ...
    def _prepare_invoice_line(self):
        ...
        res = {
            ...
            'size_back':self.size_back,
            'size_back_length':self.size_back_length,
